...
MODEL_PATH = os.path.join(SCRIPT_DIR, "dqn_model0.pth")
REWARD_LOG_PATH = os.path.join(SCRIPT_DIR, "reward_log0.json")
REWARD_PLOT_PATH = os.path.join(SCRIPT_DIR, "reward_plot0.png")
