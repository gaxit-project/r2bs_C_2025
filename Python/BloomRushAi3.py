...
MODEL_PATH = os.path.join(SCRIPT_DIR, "dqn_model3.pth")
REWARD_LOG_PATH = os.path.join(SCRIPT_DIR, "reward_log3.json")
REWARD_PLOT_PATH = os.path.join(SCRIPT_DIR, "reward_plot3.png")
